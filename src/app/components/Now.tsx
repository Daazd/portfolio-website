export default function Now() {
  return (
    <section
      id="now"
      className="border-y border-[var(--border-subtle)] bg-[var(--bg-surface)] py-20 md:py-24"
      aria-labelledby="now-heading"
    >
      <div className="section-container">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between lg:gap-24">
          <div className="max-w-md">
            <p className="font-mono-label mb-4 text-[11px] uppercase tracking-[0.35em] text-[var(--accent)]">
              Right now
            </p>
          ...
          <div className="max-w-3xl flex-1 space-y-6 text-[var(--text-muted)] leading-relaxed">
            <p>
            ...
            <p className="border-l-2 border-[var(--accent-2)]/60 pl-6 text-[var(--text)]">
